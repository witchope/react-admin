...
export const LOGIN_URL = '/msharp-admin/login';

export const APP_KEY_URL = '/pearl-server/pearl/app/name/list';

export const LOGOUT_URL = '/msharp-admin/logout';

export const SVC_LIST_URL = '/msharp-admin/registry/pageList';
